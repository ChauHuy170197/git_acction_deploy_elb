...
variable "app_source" {
  type    = string
  default = "https://elasticbeanstalk-platform-assets-us-east-1.s3.amazonaws.com/stalks/eb_php80_amazon_linux_2_1.0.1032.0_20210608222321/sampleapp/EBSampleApp-PHP.zip"
}
